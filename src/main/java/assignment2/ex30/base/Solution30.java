...
/*
 *  UCF COP3330 Summer 2021 Exercise 30 Solution
...
Challenges
Create a graphical program. Use a drop-down list to change the base number. Generate or update the table when the
number is selected.
 */
